...
Het wordt alleen gebruikt voor certificering: om subsleutels uit te geven die worden gebruikt voor codering, ondertekening en authenticatie.

Belangrijk De hoofdsleutel moet te allen tijde offline blijven en alleen toegankelijk zijn om subsleutels in te trekken of uit te geven.
...
Genereer een sterke wachtwoordzin die op een veilige plaats kan worden opgeschreven of onthouden:
